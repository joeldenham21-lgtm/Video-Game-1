...
const PRESETS := {
	...
	&"stone": ["steel", Color(0.62, 0.6, 0.58), Vector2(12.0, 12.0), 0.0, 0.25, 0.0, 1.6,
		{"mask_enabled": 1.0, "mask_albedo": Color(0.36, 0.35, 0.34), "mask_roughness": 0.5, "mask_metallic": 0.0}],
	...
	&"sleeve": ["fabric", Color(0.2, 0.27, 0.32), Vector2.ONE, 7.0, 0.0, 0.0, 1.0, {"sheen": 0.3}],
	&"sleeve_parka": ["fabric", Color(0.5, 0.13, 0.09), Vector2.ONE, 7.0, -0.05, 0.0, 1.0, {"sheen": 0.3}],
	&"sleeve_down": ["fabric", Color(0.72, 0.36, 0.08), Vector2.ONE, 7.0, -0.1, 0.0, 1.0, {"sheen": 0.35}],
	...
	&"aluminium_blue": ["aluminium", Color(0.22, 0.42, 0.72), Vector2(2.0, 4.0), 0.0, 0.0, 1.0, 1.0, {}],
